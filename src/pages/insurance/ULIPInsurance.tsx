    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl max-w-3xl mx-auto">
              Get life insurance with investment benefits
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4">Why Choose YELLOWIND SERVICES PRIVATE LIMITED ULIP Insurance?</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    <h3 className="text-lg font-medium">Investment Growth</h3>
                    <p className="mt-1 text-gray-600">Potential for higher returns through market-linked investments</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">Choose your investment funds and switch between them</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <span className="ml-3">Investment Options</span>
                  </div>
                  <div className="flex items-start">
                    <span className="flex-shrink-0 h-6 w-6 flex items-center justify-center rounded-full bg-red-100 text-red-600">
                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="ml-3">Partial Withdrawals</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-medium mb-2">What is ULIP insurance?</h3>
              <p className="text-gray-600">ULIP (Unit Linked Insurance Plan) is a combination of life insurance and investment. A portion of your premium goes towards life cover, while the rest is invested in market-linked funds of your choice.</p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-medium mb-2">How does ULIP investment work?</h3>
              <p className="text-gray-600">Your premium is invested in various funds like equity, debt, or balanced funds. The value of your investment depends on the performance of these funds. You can switch between funds based on market conditions.</p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-medium mb-2">What are the tax benefits of ULIP?</h3>
              <p className="text-gray-600">ULIPs offer tax benefits under Section 80C for premium payments and Section 10(10D) for maturity benefits. The investment growth is also tax-free.</p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-medium mb-2">Can I withdraw money from my ULIP?</h3>
              <p className="text-gray-600">Yes, you can make partial withdrawals from your ULIP after the lock-in period of 5 years. However, it's recommended to stay invested for the long term to maximize returns.</p>
            </div>
          </div>
        </div>
