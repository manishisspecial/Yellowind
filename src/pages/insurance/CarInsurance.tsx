    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl max-w-3xl mx-auto">
              Protect your car with comprehensive coverage at affordable rates
            </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
              <h2 className="text-2xl font-bold mb-4">Why Choose YELLOWIND SERVICES PRIVATE LIMITED Car Insurance?</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">Get your car repaired at network garages without paying</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <span className="ml-3">Car Photos</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="mt-12">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-medium mb-2">What is covered under car insurance?</h3>
              <p className="text-gray-600">Car insurance covers damage to your car due to accidents, theft, natural disasters, and third-party liabilities. It also includes personal accident cover for the owner-driver.</p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <p className="text-gray-600">Zero depreciation cover ensures that you get the full claim amount without any deduction for depreciation of car parts. This is especially useful for new cars.</p>
            </div>
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg font-medium mb-2">Can I transfer my car insurance to a new car?</h3>
              <p className="text-gray-600">Yes, you can transfer your car insurance to a new car. You'll need to inform us about the change and provide the new car details for policy modification.</p>
            </div>
          </div>
        </div>
